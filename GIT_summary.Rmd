...
supported by the GitHub ecosystem, and UI has recently set up its own GitHub
servise.
...
A number of programming editors Interated Develop[ment Enviornments (IDEs)
include Git support. Several Emacs Git modes are available. RStudio has
