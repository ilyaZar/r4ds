...
file, you'll notice that its status changes: the icon will change columns (within the "Status column") from
...
new icons:
    ...
    have both staged and unstaged changes in the same file. This happens when       you've made some changes, staged them, and then made some more. Clicking the     staged checkbox will stage your new changes, clicking it again will unstage     both sets of changes.
